...
if(isset($_POST['submit'])){
    ...
    $sel_c_old_pass = "select * from tbl_customer where customer_pass='$c_old_pass'";
    ...
    $update_c_pass = "update tbl_customer set customer_pass='$c_new_pass' where customer_email='$c_email'";
